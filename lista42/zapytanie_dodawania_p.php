<?php
	if ( ! isset( $_POST['Nazwa_producenta'] ) ) header('Location: http://localhost/lista42/administrator.php');
	...
	if ( isset( $_POST['Nazwa_producenta'] ) ) $Nazwa_producenta= "'".$_POST['Nazwa_producenta']."'";
	if ( isset( $_POST['url'] ) ) $url = "'".$_POST['url']."'";
	
	if ( ( $cododac == 'producenci' ) )
	{
